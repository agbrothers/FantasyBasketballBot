...
Modules for fetching One Time Passwords sent to a gmail account from various websites
-------
Supported Sites:
    ESPN
    Robinhood
...
def search_message(service, user_id, search_string):
    ...
    Function Author: 
        NormanBenbrahim
        https://github.com/NormanBenbrahim/get_emails/blob/master/get_email.py
    -------
    ...
    try:
        ...
        print("An error occured: HttpError")
...
def get_espn(user_id):
    ...
    msgs = [get_message(service, user_id, msg_id) for msg_id in ids]
...
def get_twitch(user_id):
    ...
    -------
    Parameters
        user_id : gmail account name used to sign up for twitch, i.e. name@gmail.com
    
    """
    subject = 'subject:Your Twitch Login Verification Code'    
    service = get_service()
